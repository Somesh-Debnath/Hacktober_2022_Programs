...
def calculate():
    global expression
    result = eval(expression)       # eval() funtion returns the value of string expression, >> eval("12+5") ---> o//p: 17
    v.set(result)
...
B_mul = Button(w, text = "X", bd = 10, bg = "navy", fg = "white", font = ("arial", 25, "bold"), command = lambda : btn("*"))
